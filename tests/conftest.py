...
def mock_video_response():
    ...
    return {
        ...
        "video_url": "https://platform.cdn.acedata.cloud/wan/test-task-123.mp4",
        "video_width": 1280,
        "video_height": 720,
        "state": "completed",
    }
...
def mock_task_response():
    ...
    return {
        ...
        "response": {
            ...
            "video_id": "video-456",
            "prompt": "A test video",
            "video_url": "https://platform.cdn.acedata.cloud/wan/task-123.mp4",
            "video_width": 1280,
            "video_height": 720,
            "state": "completed",
        },
        ...
        "items": [
            {
                "id": "task-123",
                "created_at": 1705788000.0,
                "request": {"action": "text2video", "prompt": "First test video"},
                "response": {
                    "success": True,
                    "task_id": "task-123",
                    "video_id": "video-456",
            ...
            },
            {
                ...
                "request": {"action": "image2video", "prompt": "Second test video"},
                "response": {
                    "success": True,
                    "task_id": "task-789",
                    "video_id": "video-012",
                    "video_url": "https://platform.cdn.acedata.cloud/wan/task-789.mp4",
                    "state": "completed",
                },
            },
        ],
